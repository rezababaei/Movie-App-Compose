...
object JetpackCompose {
    ...
    //    const val composeUiToolingPreview = "androidx.compose.ui:ui-tooling-preview:${Version.composeUiVersion}"
    const val composeUiToolingPreview = "androidx.compose.ui:ui-tooling-preview"
    const val platformComposeBom = "androidx.compose:compose-bom:${Version.composeBom}"
//  const val platformTestComposeBom="androidx.compose:compose-bom:${Version.composeBom}"
